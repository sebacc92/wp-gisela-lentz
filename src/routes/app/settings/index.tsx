                ...
                <>
                  <section class="settings-block">
                    <div>
                      ...
                      <p>
                        El resumen privado llega al número personal autorizado
                        de Gisela, con los turnos del día siguiente. El horario
                        es de Buenos Aires.
                      </p>
                    </div>
                    <div class="settings-policy-alert">
                      ...
                      <span>
                        <strong>
                          Primero escribí desde tu WhatsApp personal
                        </strong>
                        <small>
                          Cuando el resumen está habilitado, se envía sólo si
                          mandaste un mensaje al WhatsApp del consultorio en las
                          últimas 24 horas. Si la ventana está cerrada, ese día
                          se omite: no se envía una plantilla paga.
                        </small>
                      </span>
                    </div>
                    <p>
                      Podés pedir “agenda de mañana” desde ese mismo número. La
                      autorización del número y la activación del resumen se
                      configuran de forma privada; el odontograma queda dentro
                      de la app.
                    </p>
                  </section>
                  <section class="settings-block">
                    <div>
                      ...
                      <p>
                        Configurá los avisos individuales para quienes tienen
                        turno. Estos envíos son independientes del resumen
                        privado de Gisela.
                      </p>
                      <ManualHelpLink
                    ...
                    <div>
                      ...
                      <p>
                        Si querés, también podés avisar nuevamente poco antes
                        del turno.
                      </p>
                    </div>
                    <label class="settings-checkbox">
                    ...
                    <div class="settings-policy-alert">
                      ...
                      <span>
                        ...
                        <small>
                          Requieren WhatsApp y la automatización habilitados.
                          Fuera de las 24 horas desde el último mensaje del
                          paciente, requieren consentimiento y una plantilla
                          aprobada por Meta, que puede tener costo.
                        </small>
                      </span>
                    </div>
                    <button
